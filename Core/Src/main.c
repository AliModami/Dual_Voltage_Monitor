...
int main(void)
{
     ...
     * Initialize LCD.
     *
     * LCD is only used as a simple
     * output device for button test.
     */
    LCD_Init();
...
//    LCD_Print("Ready");
    ...
    {
        /*
         * Local variable used for receiving one translated
         * button command from the application layer.
         *
         ...
         *
         * 1) Buzzer_Task()
         *    Keeps buzzer state machine alive.
         *
         * 2) Buttons_Task()
         *    Reads GPIO pins and updates button state machines.
         *
         * 3) ButtonApp_Task()
         *    Converts low level button events into
        ...
        /*
         * Check whether a new button command is available.
         *
         * ButtonApp_GetCommand() also clears the command
         * after it is read, therefore one press creates
         * only one application action.
         */
